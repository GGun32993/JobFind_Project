...
$dashboard = $role === "employer" ? "../employer/dashboard.php" : "../freelancer/dashboard.php";
?>
<!DOCTYPE html>
<html lang="th">
<head>
...
<aside class="sidebar">
  <div class="sidebar-brand">
    <a href="../index.php" class="logo">
      ...
      <div>
        ...
        <div class="logo-sub" style="display:none!important;"><?php echo $role === 'employer' ? 'Employer' : ($role === 'admin' ? 'Admin' : 'Freelancer'); ?></div>
      </div>
    </a>
  </div>
  ...
  <nav class="sidebar-nav">
    ...
    <?php if($role === 'freelancer'): ?>
      <a href="../freelancer/browse_jobs.php"        class="nav-item"><i class="bi bi-briefcase"></i> Browse Jobs</a>
    ...
    <?php elseif($role === 'employer'): ?>
      <a href="../employer/post_job.php"             class="nav-item"><i class="bi bi-plus-circle"></i> Post Job</a>
      <a href="../employer/manage_jobs.php" class="nav-item"><i class="bi bi-briefcase"></i> Manage Jobs<?php render_employer_manage_jobs_badge($sidebar_pending_apps); ?></a>
      <a href="../employer/saved_freelancers.php"    class="nav-item"><i class="bi bi-bookmark"></i> Saved Freelancers</a>
      <a href="../employer/reviews.php"     class="nav-item"><i class="bi bi-star"></i> My Reviews</a>
      <a href="../employer/company_review.php"      class="nav-item"><i class="bi bi-building"></i> รีวิวบริษัท</a>
      <a href="../employer/profile.php"     class="nav-item"><i class="bi bi-person-circle"></i> My Profile</a>
    <?php endif; ?>
