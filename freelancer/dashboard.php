...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="../support/messages.php" class="nav-item">
...
<main class="main">
  ...
  <div class="topbar">
    ...
    <div class="topbar-side">
      ...
      <a href="profile.php" class="hero-action"><i class="bi bi-person"></i> Profile</a>
  ...
  <div class="job-card">
    <div class="job-logo <?php echo $job_image !== '' ? 'has-image' : ''; ?>">
      <?php if($job_image !== ''): ?>
      <img src="<?php echo htmlspecialchars(jobfind_url($job_image), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($job['title'] ?? 'Untitled Job'); ?>">
      <?php else: ?>
      <?php echo $icon; ?>
      <?php endif; ?>
    </div>
    ...
    <a href="../actions/apply_job.php?job_id=<?php echo (int)$job['job_id']; ?>" class="btn-apply">
