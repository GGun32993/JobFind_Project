...
<main class="main">
    <div class="content-container">
        ...
        <div class="job-image-gallery">
            ...
            <img src="<?php echo job_image_src($image['image_path']); ?>" alt="<?php echo htmlspecialchars($job['title'] ?? 'รูปภาพประกอบ'); ?>">
            <?php endforeach; ?>
        </div>
        <?php elseif(!empty($job['image_path'])): ?>
        <div class="job-image-section">
            <img src="<?php echo job_image_src($job['image_path']); ?>" alt="<?php echo htmlspecialchars($job['title'] ?? 'รูปประกอบงาน'); ?>">
        </div>
        <?php endif; ?>
        ...
        <div class="action-bar">
            <a href="../actions/apply_job.php?job_id=<?php echo $job_id; ?>" class="btn-apply">
