...
<aside class="sidebar">
  <div class="sidebar-brand">
    <a href="../index.php" class="logo">
      ...
      <div><div class="logo-text" style="display:none!important;">Freelance Matching Online</div><div class="logo-sub" style="display:none!important;">Admin Panel</div></div>
    </a>
  </div>
    ...
    <table class="data-table" id="user-table">
      ...
      <?php else: ?>
        ...
        <tr data-search="<?php echo htmlspecialchars($search_str); ?>"
          ...
          <td>
            <div class="act-wrap">
              <a href="edit_user.php?id=<?php echo $row['user_id']; ?>" class="btn-edit">
...
<script>
  ...
  function openDelModal(id, name){
    ...
    document.getElementById('del-link').href = 'manage_users.php?delete='+id;
