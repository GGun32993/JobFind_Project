...
if(!$job){
    echo "<script>alert('ไม่พบงานนี้'); window.location.href='manage_jobs.php';</script>";
    exit();
}
...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="manage_jobs.php" class="nav-item active"><i class="bi bi-briefcase"></i> Manage Jobs</a>
...
<main class="main">
  <div class="topbar-wrap">
    <a href="manage_jobs.php" class="btn-back"><i class="bi bi-arrow-left"></i> กลับ</a>
    <div>
      <h2>Job Detail</h2>
  ...
  <div class="detail-grid">
    ...
    <div class="card">
      ...
      <div class="job-image-gallery">
        ...
        <img src="<?php echo job_image_src($image['image_path']); ?>" alt="<?php echo htmlspecialchars($job['title']); ?>">
        <?php endforeach; ?>
      </div>
      <?php elseif(!empty($job['image_path'])): ?>
      <img src="<?php echo job_image_src($job['image_path']); ?>" alt="<?php echo htmlspecialchars($job['title']); ?>" class="job-image-preview">
      <?php endif; ?>
