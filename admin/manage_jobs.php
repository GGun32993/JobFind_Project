...
if(isset($_GET['approve'])){
    ...
    header("Location: manage_jobs.php?done=approved");
    exit();
}
...
if(isset($_GET['reject'])){
    ...
    header("Location: manage_jobs.php?done=rejected");
    exit();
}
...
<main class="main">
  ...
  <div class="job-card <?php echo $status==='pending'?'pending-card':''; ?>"
    ...
    <div class="jc-footer">
      <a href="job_detail.php?id=<?php echo $row['job_id']; ?>"
          class="btn-detail" 
...
<script>
  ...
  function confirmAction(type, id, title){
    ...
    btn.href = 'manage_jobs.php?' + type + '=' + id;
