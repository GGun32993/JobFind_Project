...
<aside class="sidebar">
  ...
  <nav class="sidebar-nav">
    ...
    <a href="reviews.php"     class="nav-item active"><i class="bi bi-star"></i> My Reviews</a>
...
<main class="main">
  ...
  <div class="summary-card">
    ...
    <div class="tip-block">
      ...
      <div class="tip-text">
        คะแนนเฉลี่ยของคุณคือ <strong><?php echo $avg; ?>/5</strong><br>
      ...
      <div class="rc-user">
        ...
        <div>
          ...
          <div class="fl-job">
            ...
            <?php echo htmlspecialchars($row['title'] ?? 'Unknown Job'); ?>
          </div>
        </div>
      </div>
...
<script>
  function setFilter(el){
    ...
    cards.forEach(c => {
      ...
      let show = star === 0 ? true : (star === 2 ? s <= 2 : s === star);
