...
<aside class="sidebar">
  <div class="sidebar-brand">
    <a href="../index.php" class="logo">
      ...
      <div><div class="logo-text" style="display:none!important;">Freelance Matching Online</div><div class="logo-sub" style="display:none!important;">Employer</div></div>
    </a>
  </div>
  <nav class="sidebar-nav">
    ...
    <a href="company_review.php"      class="nav-item active"><i class="bi bi-building"></i> รีวิวบริษัท</a>
