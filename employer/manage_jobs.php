  ...
  <div class="job-card <?php echo $border_class; ?>"
    ...
    <div class="jc-top">
      <div style="display:flex;align-items:center;gap:12px;">
        <div class="jc-media">
          <?php if($job_image !== ''): ?>
          <img src="<?php echo htmlspecialchars(jobfind_url($job_image), ENT_QUOTES, 'UTF-8'); ?>" alt="<?php echo htmlspecialchars($row['title']); ?>">
          <?php else: ?>
          <?php echo $icon; ?>
          <?php endif; ?>
        </div>
    ...
    <div class="jc-footer">
      <div class="act-wrap">
        ...
        <?php if($sts === 'approved'): ?>
        <a href="../actions/complete_job.php?job_id=<?php echo $row['job_id']; ?>" class="act-btn ab-complete"
...
<script>
  ...
  function confirmDelete(id, title){
    ...
    document.getElementById('del-link').href = 'manage_jobs.php?delete=' + id;
