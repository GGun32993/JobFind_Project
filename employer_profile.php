...
<aside class="sidebar">
  <div class="sidebar-brand">
    <a href="index.php" class="logo">
      ...
      <div><div class="logo-text" style="display:none!important;">Job_Find</div><div class="logo-sub" style="display:none!important;"><?php echo $current_role == 'employer' ? 'Employer' : 'Freelancer'; ?></div></div>
    </a>
  </div>
