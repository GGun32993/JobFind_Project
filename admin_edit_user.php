...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    header("Location: admin_edit_user.php?id=$edit_user_id&toast=$toast"); exit();
}
...
if($result->num_rows === 0){
    echo "<script>alert('ไม่พบผู้ใช้งานนี้'); window.location.href='admin_manage_users.php';</script>";
    exit();
}
...
<title>Edit User - Job_Find Admin</title>
...
<main class="main">
  ...
  <div class="topbar">
    <div class="topbar-wrap">
      <a href="admin_manage_users.php" class="btn-back">
    ...
    <div class="form-card">
      ...
      <form method="POST">
        ...
        <div class="form-actions">
          ...
          <a href="admin_manage_users.php" class="btn-cancel-edit">
